 ...
 * @version 4.0.0
 */
public class OperationInterceptorFactory extends AbstractLoadInterceptor<AbstractLoadContext, EventData> {
    ...
    public void transactionBegin(AbstractLoadContext context, List<EventData> currentDatas, DbDialect dialect) {
    ...
    public void transactionEnd(AbstractLoadContext context, List<EventData> currentDatas, DbDialect dialect) {
        LoadInterceptor[] interceptors = getIntercetptor(context, currentDatas);
        for (LoadInterceptor interceptor : interceptors) {
    ...
    private LoadInterceptor[] getIntercetptor(AbstractLoadContext context, List<EventData> currentData) {
